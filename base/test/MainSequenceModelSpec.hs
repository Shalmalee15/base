  ...
  describe "MS Model file format" $ do
    ...
    describe "Model" $ do
      ...
      it "parses" $
        ...
        in result `shouldBe` [ (-2.5, [ ( 8.39794,  [2, 3, 4, 5], [0.278163, 0.318852, 0.335466, 0.351598] )
                                      , ( 8.477121, [2, 3, 4, 5], [0.212681, 0.290489, 0.320389, 0.335518] )])
                             , (-2.0, [ ( 8.397940, [2, 3, 4, 5], [0.297801, 0.335484, 0.338823, 0.355097] )
                                      , ( 8.477121, [2, 3, 4, 5], [0.251276, 0.317207, 0.335075, 0.337718] )])]
